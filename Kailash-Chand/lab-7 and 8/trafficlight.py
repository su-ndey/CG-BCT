...
red_circle = {"pos": (375, 150), "radius": 50, "color": RED, "dim_color": DIM_RED}
yellow_circle = {"pos": (375, 300), "radius": 50, "color": YELLOW, "dim_color": DIM_YELLOW}
green_circle = {"pos": (375, 450), "radius": 50, "color": GREEN, "dim_color": DIM_GREEN}

lights = [red_circle, yellow_circle, green_circle]  
messages = [" ", "READYY", "GOOOO" ]
